const TOPIC_03 = {
    ...
    exercises: [
        {
            ...
            answer: "\\(\\displaystyle \\lim_{x \\to 1} \\frac{(x+1)(x-1)}{x-1} = \\lim_{x \\to 1} (x+1) = 2\\) ប៉ុន្តែ \\(\\displaystyle f(1)\\) គ្មាន → មិនជាប់ (removable)"
        },
        {
            id: 2,
            ...
            answer: "\\(\\displaystyle \\lim_{x \\to 2^-} f(x) = 3\\), \\(\\displaystyle \\lim_{x \\to 2^+} f(x) = 3\\), \\(\\displaystyle f(2) = 3\\) → ជាប់"
        },
        {
            id: 3,
    ...
    content: `
        ...
        <ol>
            ...
            <li>\\(\\displaystyle \\lim_{x \\to a} f(x)\\) មានតម្លៃ</li>
        ...
        <div class="example-box">
            ...
            <p>\\(\\displaystyle \\lim_{x \\to 1} \\frac{(x+1)(x-1)}{x-1} = \\lim_{x \\to 1} (x+1) = 2\\) ប៉ុន្តែ \\(\\displaystyle f(1)\\) គ្មាន → មិនជាប់ (removable)</p>
        </div>
    `
};
